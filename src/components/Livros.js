...
const Livros = () => {
    return (
      <Container className="container-livros">
        <Grid container spacing={2} sx={{p:4}}>
          <Grid xs={12} sm={6} className="grid-left">
            <h1>Livros</h1>
          ...
          <Grid xs={12} sm={6} className="grid-right">
            <Grid container spacing={2} sx={{p:4}}>
                <Grid xs={8} sm={6}>
                    <svg width="" height="" viewBox="300 100 664 614" fill="none" xmlns="http://www.w3.org/2000/svg">
